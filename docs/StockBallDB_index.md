...
| [StockBallDB_V2_architecture.md](StockBallDB_V2_architecture.md) | **V2 backend/application architecture** — façade, layers, read vs maintenance, package sketch |
...
| V2 backend / application architecture | V2_architecture |
